...
export default function TermsPage() {
  return (
    <CorporatePage
      ...
      description="This website provides public information about Ochiga, infrastructure deployments, digital twins, command centers, Oyi ecosystem deployments, and related services."
    >
