...
export default function ThreeLanding() {
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", position: "relative" }}>
      ...
      {/* RIGHT INFO PANEL */}
      <div style={{ position: "absolute", right: 20, top: 20, zIndex: 60, width: 320 }}>
        <div style={{ background: "rgba(255,255,255,0.95)", padding: 12, borderRadius: 12 }}>
          <strong>Scene</strong>
          <select
            value={sceneKey}
            onChange={(e) => setSceneKey(e.target.value as SceneKey)}
        ...
        <div style={{
          ...
          <div style={{ padding: 18, background: "white", borderRadius: 12 }}>
            ...
            <div style={{ marginTop: 12, display: "flex", gap: 8 }}>
              <button style={{ padding: 10 }}>Learn More</button>
              <button style={{ padding: 10 }}>Request Quote</button>
            </div>
          </div>
        </div>
      )}
