      ...
      <section className="px-4 md:px-8 pt-24 md:pt-28">
        <div className="hero-frame">
          ...
          <div className="hero-content animate-fade-up">
            ...
            <p className="hero-description">The architecture behind Oyi OS: realtime events, AI, device integration, edge infrastructure, security, and the digital twin foundation.</p>
